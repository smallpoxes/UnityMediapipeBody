...
public class PipeServerV2 : MonoBehaviour
{
    ...
    public class Body 
    {
        ...
        public Body(Transform parent, GameObject landmarkPrefab, GameObject digitPrefab, GameObject linePrefab, float s, GameObject headPrefab)
        {
            this.parent = parent;
            ...
            for (int i = 0; i < instances.Length; ++i)
            {
                ...
                {
                    instances[i] = Instantiate(digitPrefab);
    ...
    private void Start()
    {
        ...
        body = new Body(parent, landmarkPrefab, digitPrefab, linePrefab, landmarkScale, enableHead ? headPrefab : null);
